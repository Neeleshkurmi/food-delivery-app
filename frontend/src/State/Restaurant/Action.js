...
export const updateRestaurantRequest = ({restaurantId, restaurantData, jwt}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            dispatch({type:UPDATE_RESTAURANT_SUCCESS,payload:error});
        }
    };
};
...
export const getAllEvents = ({jwt}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            console.log("get all events response ", res.data);
...
export const getRestaurantEvents = ({restaurantId, jwt}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            console.log("get restaurant events response ", res.data);
...
export const getRestaurantsCategory = ({jwt, restaurantId}) => {
    return async (dispatch) => {
        ...
        try{
            ...
            console.log("get restaurant category response ", res.data);
...
export const getRestaurantOrders = ({ restaurantId, jwt, order_status }) => {
    return async (dispatch) => {
